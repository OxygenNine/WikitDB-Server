...
<head>
<meta charset="utf-8">
<meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src data: https://*.wikidot.com https://*.wdfiles.com; style-src 'unsafe-inline'; font-src data:; frame-src 'none'; media-src https://*.wikidot.com https://*.wdfiles.com; form-action 'none'; base-uri 'none'">
...
export function getStaticProps() {
    return {
        props: {
            sites: config.SUPPORT_WIKI.map(site => ({
                name: site.NAME,
                param: site.PARAM,
